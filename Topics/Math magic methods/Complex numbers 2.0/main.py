class ComplexNumber:
    ...
    def __truediv__(self, other):
        ...
        other_inverse_real_part = other.real_part / denominator
        other_inverse_im_part = -other.im_part / denominator
        real = self.real_part * other_inverse_real_part - self.im_part * other_inverse_im_part
        imaginary = self.real_part * other_inverse_im_part + other_inverse_real_part * self.im_part
        return ComplexNumber(real, imaginary)
